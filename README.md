...
## TEVC data (works with from MATLAB_R2014b to R2020b - have not tested above)
...
[Jupyter notebooks](https://github.com/wormsenseLab/JupyterNotebooksDEGENaCPharm.git)
